...
class ZoneDetails(QFrame):
    ...
    def __init__(self):
        ...
        self.label_nom = QLabel("Titre : ")
        self.label_info = QLabel("Description : ")
    ...
    def action_ouvrir(self):
        """Ouverture de fichier (Windows, Mac, Linux)."""
...
class FenetrePrincipale(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Sélection d'un document et boutons d'actions")
        self.resize(600, 400)
        ...
        # Bouton Séléction du fichier
        self.btn_test_select = QPushButton("Séléction d'un document")
    ...
    def tester_selecteur(self):
        ...
        if path:
            ...
            self.details.mettre_a_jour(nom_fichier, "Fichier sélectionné via ..", path)
